                            ...
                            if ($value['type_id'] == $id) { ?>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input name="type_id" type="text" id="inputName" class="form-control" value="<?php echo $value['type_id'] ?>"disabled> 
                                    </div>
                                    <div class="form-group">
                        ...
                        if ($value['manu_id'] == $id) { ?>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="manu_id" type="text" id="inputName" class="form-control" value="<?php echo $value['manu_id'] ?>"disabled>
                                </div>
                                <div class="form-group">
                        ...
                        if ($value['user_id'] == $id) { ?>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="user_id" type="text" id="inputName" class="form-control" value="<?php echo $value['user_id'] ?>"disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="role_id" type="text" id="inputClientCompany" class="form-control" value="<?php echo $value['role_id'] ?>">
                                </div>
                                <div class="form-group">
